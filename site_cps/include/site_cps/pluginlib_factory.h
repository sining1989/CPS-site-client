#ifndef SITE_CPS_PLUGINLIB_FACTORY_H
#define SITE_CPS_PLUGINLIB_FACTORY_H
...
public:
  ...
  {
    QIcon icon = QIcon( ":/icon/icons/"+class_name+".png" );
    if ( icon.isNull() )
    {
      icon = QIcon( ":/icon/icons/default_class_icon.png");
    }
...
#endif // SITE_CPS_PLUGINLIB_FACTORY_H
