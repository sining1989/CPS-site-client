  ...
  , collapsed_(false)
{
  ...
  if (name == "Setting")
  {
     strTemp = PANEL_SETTING;
  }
  else if (name == "MasterConfiguration")
  {
     strTemp = PANEL_MASTERMSG;
  }
  else if (name == "TaskConfiguration")
  {
     strTemp = PANEL_TASKPRESENT;
  }
  else if (name == "Camera")
  {
     strTemp = PANEL_VIDEO;
  ...
  title_label_ = new QLabel( strTemp, this );
